	...
	$("#helpButton").click(function () {
		...
		$("#commitClone").click(function () { 
			...
			$.ajax({
				...
				'platforms' : escape(platforms.join(",")),
				'handlers' : escape(handlers.join(",")),
				},
		...
		$("#commitEdit").click(function(){ 
			...
			$.ajax({
    			...
    			'success' : function(data) {
			 		var jsondata = $.parseJSON(data);
					if (jsondata.updated)
						myAlert("Job description updated successfully(dummy function, doesn't really updates the new object)","","Attention","");
      			}
    		});/* /ajax*/
		});/* commitEdit */
});
