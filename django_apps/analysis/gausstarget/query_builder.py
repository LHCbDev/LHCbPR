def get_queries(requestData, app_name):
    ...
    query_results = 'select ' + ' , '.join(select_statements) + ' ,rf. "FILE" from ' + ' , '.join(
        from_statements) + ' where ' + ' and '.join(where_statements)
    query_groups = 'select distinct ' + ' , '.join(select_statements) + ' from ' + ' , '.join(
        from_statements) + ' where ' + ' and '.join(where_statements)
